    ...
    def _parse_body(self, sqlite_present):
        ...
        with open(self.filename, "rb") as f:
            ...
            for i in range(0, self.framecount):
                ...
                #print(frame_page_number,frame_offset)
                ...
                if not isinstance(result, int):
                    ...
                    alldata.append(x)
                    d["wal"][i] = result
                    self.rgen.generateReport(i, result, alldata)
                #print("++++++++++++++++++++++++++\n",d,"\n++++++++++++++++++++++++")
        self.rgen.jsonconvert(self.outname , super(WALParser, self)._path_leaf(self.filename), self.page_size)
